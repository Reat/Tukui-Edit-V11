...
if TukuiCF["Datatext"].hps and TukuiCF["Datatext"].hps > 0 then
	...
	hText:SetFont(TukuiCF["Datatext"].font, TukuiCF["Datatext"].fontsize)
	hText:SetText("0.0 ",tukuilocal.datatext_hps)
 
	TukuiDB.PP(TukuiCF["Datatext"].hps, hText)
