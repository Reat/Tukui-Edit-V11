...
if TukuiCF["Datatext"].dps and TukuiCF["Datatext"].dps > 0 then
	...
	dText:SetFont(TukuiCF["Datatext"].font, TukuiCF["Datatext"].fontsize)
	dText:SetText("0.0 ",tukuilocal.datatext_dps)

	TukuiDB.PP(TukuiCF["Datatext"].dps, dText)
